...
def get_train_options():
    ...
    parser.add_argument('--lambda_adversarial', type=float, default=1.0, help='weight for GAN loss')
    ...
    parser.add_argument('--lambda_perceptual_texture', type=float, default=0.1, help='weight for shallow VGG-based perceptual loss for texture (e.g. 1.0)')
    parser.add_argument('--lambda_gram', type=float, default=0.1, help='weight for Gram matrix style loss (e.g. 0.5)')
    ...
    parser.add_argument('--lambda_tv', type=float, default=0.1, help='weight for total variation loss (for smoothing, e.g. 1e-4)')
